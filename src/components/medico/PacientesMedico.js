import { faHistory, faSyringe } from "@fortawesome/free-solid-svg-icons";
                                        ...
                                        return (
                                            <tr className="hover:bg-gray-200">
                                                ...
                                                <td className="text-center">
                                                    <Link to={`/medico/historial/${paciente?.id}`}>
                                                        <FontAwesomeIcon
                                                ...
                                                <td className="text-center">
                                                    <Link to={`/medico/pacienteConsultas/${paciente?.id}`}>
                                                        <FontAwesomeIcon
                                                            className="mx-2 text-blue-500"
                                                            icon={faSyringe}
                                                        />
